...
export default function OurProcess() {
  return (
    <div className="flex flex-col items-center justify-center py-[75px] bg-darkGray">
      ...
      <div className="px-[12px] md:flex md:flex-wrap md:justify-center md:items-center md:gap-[30px]">
        ...
        <CardOP icon="teenyicons:layers-subtract-outline" header="Production" description="The best crews with the most up-to-date gear and technologies capture your story. Duis aute irure dolor." />
        <CardOP icon="ph:layout-light" header="Post Production" description="Producers, editors, designers, and animators, shape and sculpt your video ‘til it’s ready for prime time." />
      </div>
    </div>
  )
}