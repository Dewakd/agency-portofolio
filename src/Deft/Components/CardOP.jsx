...
export default function CardOP({ icon, header, description }) {
  return (
    <div className="flex flex-col items-center justify-center py-[20px] md:max-w-[350px]">
      ...
      <h1 className="md:text-[24px] text-white mt-[20px] mb-[10px] font-poppins font-bold text-[18px]">{header}</h1>
